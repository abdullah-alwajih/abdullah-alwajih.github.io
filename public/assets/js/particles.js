...
const pJS = function (tag_id, params) {
  ...
  pJS.fn.interact.attractParticles = function (p1, p2) {
    ...
    if (dist <= pJS.particles.line_linked.distance) {
      const ax = dx / (pJS.particles.move.attract.rotateX * 1000), ay = dy / (pJS.particles.move.attract.rotateY * 1000)
  ...
  pJS.fn.interact.bounceParticles = function (p1, p2) {
    const dx = p1.x - p2.x, dy = p1.y - p2.y, dist = Math.sqrt(dx * dx + dy * dy), dist_p = p1.radius + p2.radius
  ...
  pJS.fn.modes.repulseParticle = function (p) {
    ...
    if (pJS.interactivity.events.onhover.enable && isInArray('repulse', pJS.interactivity.events.onhover.mode) && pJS.interactivity.status == 'mousemove') {
      const dx_mouse = p.x - pJS.interactivity.mouse.pos_x, dy_mouse = p.y - pJS.interactivity.mouse.pos_y,
        dist_mouse = Math.sqrt(dx_mouse * dx_mouse + dy_mouse * dy_mouse)
      ...
      if (pJS.tmp.repulse_clicking) {
        ...
        const dx = pJS.interactivity.mouse.click_pos_x - p.x, dy = pJS.interactivity.mouse.click_pos_y - p.y,
          d = dx * dx + dy * dy
  ...
  pJS.fn.vendors.createSvgImg = function (p) {
    ...
    const svgXml = pJS.tmp.source_svg, rgbHex = /#([0-9A-F]{3,6})/gi,
...
window.particlesJS = function (tag_id, params) {
  ...
  /* pJS elements */
  const pJS_tag = document.getElementById(tag_id), pJS_canvas_class = 'particles-js-canvas-el',
...
particlesJS('particles-js', {
  particles: {
    number: {
      ...
      enable: true, distance: 150, color: '#fec966', opacity: 0.4, width: 1,
    }, move: {
      enable: true,
      speed: 3,
      direction: 'none',
    ...
    detect_on: 'window', events: {
      ...
      grab: {
        ...
        distance: 400, size: 100, duration: 2, opacity: 8, speed: 3,
      }, repulse: {
